...
abstract class BaseListView<T, C extends RSBaseListController<T>>
  ...
  final RSBaseListController<T> controller;
...
class _BaseListViewState<T, C extends RSBaseListController<T>>
