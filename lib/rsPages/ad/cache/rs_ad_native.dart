...
import '../models/rs_ad_load_result.dart';
import '../rs_ad_cache_config.dart';
import '../rs_ad_loader.dart';
import '../rs_ad_type.dart';
import '../rs_my_ad.dart';
...
class ADNative with MyAdEventHandler {
  ...
  Future<bool> loadAd({required PlacementType placement}) async {
    ...
    try {
      ...
      final sortList = list.where((e) => e.id?.isNotEmpty ?? false).toList()
