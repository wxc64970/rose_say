...
import 'services/rs_ad_analytics.dart';
...
class MyAdCallback {
  ...
  final void Function(AdType type, AdError error, {PlacementType? placement})?
  onAdFailedToShow;
  final void Function(AdType type, AdError error, {PlacementType? placement})?
  onAdFailedToLoad;
  final void Function(
  ...
  onAdRevenue;
  final void Function(RewardItem reward, {PlacementType? placement})?
  onUserEarnedReward;
