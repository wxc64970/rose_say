...
import 'cache/rs_ad_native.dart';
import 'models/rs_ad_config.dart';
import 'rs_ad_type.dart';
import 'rs_app_lifecycle_reactor.dart';
import 'rs_my_ad_callback.dart';
...
class MyAd {
  ...
  Future<void> initAdConfig() async {
    String? adConfigStr = RSThirdPartyService.adConfig;
    ...
    if (adConfigStr != null && adConfigStr.isNotEmpty) {
      ...
      jsonMap = RSAppConstants.isDebug
          ? {
              "interval": 15,
              "homelist": [
                {
