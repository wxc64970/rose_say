...
class AdCacheConfig {
  ...
  /// 不同广告类型的缓存时间配置
  final Map<AdType, Duration> _cacheDurations = {
    AdType.open: defaultOpenCacheDuration,
    AdType.interstitial: defaultCacheDuration,
    AdType.rewarded: defaultCacheDuration,
  };
