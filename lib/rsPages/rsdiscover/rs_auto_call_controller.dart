...
import 'package:rose_say/rsPages/rsapplication/controller.dart';

class RSAutoCallController extends GetxController {
  // 主动来电
  ...
  bool canCall() {
    ...
    if (Get.find<RsapplicationController>().state.page != 0) {
      return false;
    }

    if (RoutePages.observer.curRoute?.settings.name !=
        RSRouteNames.application) {
