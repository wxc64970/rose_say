...
import 'package:rose_say/rsPages/rschat/widgets/rs_f_c.dart';
import 'package:rose_say/rsPages/rsdiscover/controller.dart';

import 'index.dart';

class RssearchController extends GetxController {
  RssearchController();

  final state = RssearchState();
  ...
  void _setLoadingState() {
    state.type.value = EmptyType.RSLoading;
  }
  ...
  void _notifyFollowEvent(bool isCollected, String chatId) {
    try {
      ...
      RSLogUtil.d('通知关注事件: $followEvent, chatId: $chatId');
