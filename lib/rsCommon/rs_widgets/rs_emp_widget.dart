...
class EmptyWidget extends StatelessWidget {
  ...
  /// Optional color for the RSLoading indicator
  ...
  Widget _createContent(double width, double height, List<Widget> widgets) {
    ...
    if (type != EmptyType.RSLoading && height / width > 1.3) {
  ...
  Widget build(BuildContext context) {
    ...
    if (type == EmptyType.RSLoading) {
      // RSLoading state - show activity indicator
      widgets.add(RSLoading.activityIndicator());
    } else {
...
enum EmptyType { RSLoading, noData, noNetwork, noSearch, noChat }
...
extension EmptyTypeExt on EmptyType {
  ...
  Widget image({double? width, double? height}) {
    ...
    var name = 'assets/images/rs_no_data.png';
    switch (this) {
      case EmptyType.noData:
        name = 'assets/images/rs_no_data.png';
        break;
      case EmptyType.noChat:
        name = 'assets/images/rs_no_chat.png';
        break;
      case EmptyType.noNetwork:
        name = 'assets/images/rs_no_network.png';
        break;
      case EmptyType.noSearch:
        name = 'assets/images/rs_no_data.png';
        break;
      case EmptyType.RSLoading:
        name = 'assets/images/rs_no_data.png';
        break;
    }
  ...
  String text() {
    switch (this) {
      case EmptyType.RSLoading:
        return RSTextData.RSLoading;
      case EmptyType.noData:
        return RSTextData.noData;
      case EmptyType.noNetwork:
        return RSTextData.noNetwork;
      case EmptyType.noChat:
        return RSTextData.noChat;
      case EmptyType.noSearch:
        return RSTextData.noData;
    }
  }
