...
class RSImagePreviewScreen extends StatefulWidget {
  const RSImagePreviewScreen({super.key});

  @override
  State<RSImagePreviewScreen> createState() => _RSImagePreviewScreenState();
}

class _RSImagePreviewScreenState extends State<RSImagePreviewScreen> {
