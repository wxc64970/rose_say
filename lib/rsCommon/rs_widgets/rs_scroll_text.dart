...
class RSAutoHeightScrollText extends StatefulWidget {
  final String text;
  ...
  @override
  State<RSAutoHeightScrollText> createState() => _RSAutoHeightScrollTextState();
}

class _RSAutoHeightScrollTextState extends State<RSAutoHeightScrollText> {
  ...
  @override
  void didUpdateWidget(covariant RSAutoHeightScrollText oldWidget) {
