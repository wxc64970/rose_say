...
class RSVideoPreviewScreen extends StatefulWidget {
  const RSVideoPreviewScreen({super.key});

  @override
  State<RSVideoPreviewScreen> createState() => _VideoPreviewScreenState();
}

class _VideoPreviewScreenState extends State<RSVideoPreviewScreen>
  ...
  Future<void> _initializeVideo() async {
    try {
      if (url!.startsWith('http://') || url!.startsWith('https://')) {
        RSLoading.show();
        final path = await FileDownloadService.instance
