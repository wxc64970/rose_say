...
part of 'rs_eve_data.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class EventDataAdapter extends TypeAdapter<RSEventData> {
  @override
  final int typeId = 0;

  @override
  RSEventData read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, RSEventData obj) {
    writer
      ..writeByte(8)
      ..writeByte(0)
      ..write(obj.id)
