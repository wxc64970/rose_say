...
void main() {
  test('ACryptoFactory encrypt and decrypt test', () {
    ...
    // 测试加密和解密往返
    final encryptedImageUrl = RSCryptoUtil.encrypt(imageUrl);
    final decryptedImageUrl = RSCryptoUtil.decrypt(encryptedImageUrl);
    print('Encrypted imageUrl: $encryptedImageUrl');
    print('Decrypted imageUrl: $decryptedImageUrl');

    final encryptedVideoUrl = RSCryptoUtil.encrypt(videoUrl);
    final decryptedVideoUrl = RSCryptoUtil.decrypt(encryptedVideoUrl);
